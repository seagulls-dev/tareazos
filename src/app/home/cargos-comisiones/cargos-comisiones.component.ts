...
@Component({
    selector: "app-cargos-comisiones",
    templateUrl: "./cargos-comisiones.component.html",
    styleUrls: ["./cargos-comisiones.component.scss"],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class CargosComisionesComponent implements OnInit, OnDestroy {
    showMenu = false;
    fuseConfig: any;
    navigation: any;
